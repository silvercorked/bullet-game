...
export default class Input {
	...
	static SwapArrays() {
		...
		if (Object.keys(this.frameKeysDown).length > 0)
			SceneManager.currentScene.callMethod("onKeyDown", this.frameKeysDown);
		if (Object.keys(this.frameKeysUp).length > 0)
			SceneManager.currentScene.callMethod("onKeyUp", this.frameKeysUp);
		if (Object.keys(this.frameMouseButtonsDown).length > 0)
			SceneManager.currentScene.callMethod("onMouseButtonDown", {buttons:this.frameMouseButtonsDown, location:this.frameMousePosition});
		if (Object.keys(this.frameMouseButtonsUp).length > 0)
			SceneManager.currentScene.callMethod("onMouseButtonUp", {buttons:this.frameMouseButtonsUp, location:this.frameMousePosition});
		if (this.frameScrollWheel != 0)
